...
import { Between, ILike, LessThan, LessThanOrEqual, Like, MoreThan, Not, Repository } from 'typeorm';
  ...
  getUsers() {
    return this.userRepository.find({
      ...
      where: {
        ...
        // 같은 경우
        // id: Equal(30)
        // 유사값 -> %% 앞뒤로 어떤 글자가 와도 상관없음, 대분자 구분 X
        // email: Like('%google*')
        // 대문자 소문자 구분 안하는 유사값
        // email: ILike('%GOOGLE%')
        // 사이값
